...
And I found the path at `?image_id=a.jpg&pagename=/etc/Development/php-reverse-shell` eventuall. Note the capitalized D in development. Took me a bit too long to figure that out.
