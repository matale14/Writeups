...
I quickly check out the website, but it's very bare, so lets check out the ftp.
...
And used meterpreters own exploit suggester to find a possible escalation exploit.
